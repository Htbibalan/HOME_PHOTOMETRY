...
class FED3MonitorApp:
    ...
    def show_port_mapping_message(self):
        message = (
            ...
            "6) GPIO pin mapping for Raspberry Pi 4B is:\n\n"
    ...
    def create_layout(self):
        ...
        footer_label = tk.Label(bottom_frame, text="© 2025 McCutcheonlab | UiT | Norway", font=("Cascadia Code", 10), fg="black")
